            ...
            <div class="row ">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="<%= ((Cliente)session.getAttribute("cliiente")).getK_num_documento()%>"
                               class="form-control" id="txtId" name="txtId" placeholder="Nuemro de identificación">
                    </div>
                    <div class="form-group">
                        <label for="numero_perfil">#Perfil</label>
                        <input type="text" value="<%= ((Cliente)session.getAttribute("cliiente")).getK_tipo_documento()%>" 
                               class="form-control" id="k_tipo_documento" name="k_tipo_documento" placeholder="Tipo identificacion">
                    </div>
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" value="<%= ((Cliente)session.getAttribute("cliiente")).getN_primer_nombre()%>" 
                               class="form-control" id="n_primer_nombre" name="n_primer_nombre" placeholder="Primer nombre" z>
                    </div>
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" value="<%= ((Cliente)session.getAttribute("cliiente")).getN_segundo_nombre()%>" 
                               class="form-control" id="n_segundo_nombre" name="n_segundo_nombre" placeholder="Segundo nombre" z>
                    </div>
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" value="<%= ((Cliente)session.getAttribute("cliiente")).getN_primer_apellido()%>" 
                               class="form-control" id="n_primer_apellido" name="n_primer_apellido" placeholder="Primer apellido" z>
                    </div>
                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" value="<%= ((Cliente)session.getAttribute("cliiente")).getN_segundo_apellido()%>" 
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" value="<%= ((Cliente)session.getAttribute("cliiente")).getO_genero()%>" class="form-control" id="o_genero" name="o_genero" placeholder="Género">
                    </div>
                    <div class="form-group ">
                        <label for="apellido">Género</label>
                        <input type="text" value="<%= ((Cliente)session.getAttribute("cliiente")).getF_nacimiento()%>" 
                               class="form-control" id="f_nacimiento" name="f_nacimiento" placeholder="Fecha nacimiento">
                    </div>
                    <div class="form-group ">
                        <label for="apellido">Género</label>
                        <input type="text" value="<%= ((Cliente)session.getAttribute("cliiente")).getN_correo()%>" 
